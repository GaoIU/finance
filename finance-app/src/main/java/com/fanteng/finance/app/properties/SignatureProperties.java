...
public class SignatureProperties {
	...
	/** 客户端AES密钥 */
	public static final String CLIENT_AES_KEY = "wwTYh0liKdjlIniHh1DNAQ==";
...
//		String params = "{}";
//		String data = AESUtil.encoder(params, CLIENT_AES_KEY);
//		System.out.println("请求参数：" + data);
//
//		String key = RSAUtil.encoderByPublicKey(CLIENT_AES_KEY, SERVER_PUBLIC_KEY);
