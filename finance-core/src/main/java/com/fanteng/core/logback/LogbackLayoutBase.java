...
public class LogbackLayoutBase extends PatternLayoutBase<ILoggingEvent> {
	...
	static {
		...
		defaultConverterMap.put("easyHighlight", LogbackCompositeConverter.class.getName());
		defaultConverterMap.put("pid", LogbackClassicConverter.class.getName());

	}

	public LogbackLayoutBase() {
